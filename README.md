...
Docker images are generated when the npm package version is bumped. Branch [staging](https://github.com/tomjtoth/saldo/tree/staging) is deployed [here](https://staging.saldo.ttj.hu), providing access to (the clone of) production data.
